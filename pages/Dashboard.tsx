    ...
    <div className="h-screen bg-slate-50 flex font-sans text-slate-900 overflow-hidden relative">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden w-full relative bg-slate-50">
        ...
        <header className="lg:hidden h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 flex-shrink-0 z-30">
           <div className="flex items-center gap-3">
             <button onClick={() => setSidebarOpen(true)} className="text-slate-500 p-1 hover:bg-slate-100 rounded-md">
        ...
        <div className="flex-1 overflow-y-auto p-4 lg:p-10 scrollbar-hide">
            ...
            {/* Mobile/Tablet Intelligence Block (Only shows when right sidebar is hidden) */}
