...
*   **Search Grounding:** Step 1 successfully verifies real-world businesses.
...
|------|------------------|-------------------|-----------------------|------------------------|---------------------|----------------|-------------------|
| **Wizard** | Screen 1 (Context) | ✅ Complete | ✅ Complete | ✅ Search Grounding | ✅ Researcher + Analyst | ✅ Edge Function | Add error UI for bad URLs. |
| **Wizard** | Screen 2 (Deep Dive) | ✅ Complete | ✅ Complete | ✅ Structured Output | ✅ Consultant | ✅ Edge Function | Optimize generation speed. |
...
- **Logic:** Generates questions based on detected industry (e.g., asking "SKU Limit" for Retail).
...
```mermaid
graph LR
    User[User Input] -->|Step 1| Edge1[analyze-business]
    Edge1 -->|Search Tool| Gemini
    Gemini -->|Analysis| User
    
    User -->|Step 2| Edge2[generate-questions]
    Edge2 --> Gemini
    Gemini -->|Questions| User
    
    User -->|Step 3| Edge3[recommend-systems]
    Edge3 --> Gemini
    Gemini -->|Systems| User
    
    User -->|Step 5| Edge4[generate-strategy]
    Edge4 --> Gemini
    Gemini -->|Roadmap| Dashboard[Client Dashboard]
